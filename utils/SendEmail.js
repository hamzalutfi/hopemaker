            ...
            <td>
              <table cellpadding="0" cellspacing="0" role="presentation">
                ...
                <tr>
                  <td>
                    <div>
                      <h1>Reset Your PETS Password</h1>
                      <p>You recently requested to reset your password for your Doctorna account. Use the code below to reset it. <strong>This password reset is only valid for the next 24 hours.</strong></p>
                      <!-- Action -->
...
<head>
  ...
  <title>Activate your Doctorna account</title>
...
<body>
<span class="preheader">Use this link to activate your Pets account.</span>
              ...
              <tr>
                <td class="content-cell">
                  <div class="f-fallback">
                    <h1>Activate Your Pets Account</h1>
                    <p>Welcome to Pets! To get started, please click the button below to activate your account.</p>
                    <!-- Action -->
                    ...
                    <p>If you didn't create an account with pets, you can safely ignore this email.</p>
                    <p>Thanks,<br>The pets Team</p>
                  </div>
                </td>
              </tr>
            </table>
